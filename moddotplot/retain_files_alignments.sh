#!/bin/bash
# Run real-read alignments but retain all intermediate files
# Usage: retain_files_alignments.sh <hap name> <chromosome>
# Example: retain_files_alignments.sh HG01106.1 chr10

set -e

# ---- process arguments ----

echo "Top of retain_files_alignments.sh with ${1} ${2} input"
